...
`results/mc-range.json` is the LLM-measured surface and is **not** regenerated by
that command (or by any test) — it costs subscription quota and is non-deterministic.
